...
public class SimpleCalc extends Application {
     ...
     public void start(Stage stage) {
          ...
          VBox inputPane = new VBox(5, xPane, yPane);
          ...
          GridPane numPad = new GridPane(); //Grid holding the number keys

          for(int i=0; i<10; i++) {

               Button numKey = new Button(String.valueOf(i));
               numKey.setOnAction(e -> xInput.setText(xInput.getText() + numKey.getText()));
               if(i==0) {
                    numPad.add(numKey,1,3);
               } else{
                    numPad.add(numKey, (i-1)%3, (i-1)/3);
               }

          }


          VBox root = new VBox( 10, inputPane, buttonPane, numPad, answer );
