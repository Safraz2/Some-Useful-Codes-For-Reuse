...
public class TextInputDemo extends Application {
     ...
     public void start(Stage stage) {
          ...
          /* A button that will clear the TextArea.  It also selects all the
          ...
          BorderPane.setMargin(contentInput, new Insets(3));  // Set margins around components
          BorderPane.setMargin(titleInput, new Insets(3,3,3,3));
